      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 md:px-24 py-12">
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground">Start building your developer career today.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="name" className="font-semibold uppercase text-xs tracking-wider text-muted-foreground">Full Name</Label>
              <Input 
                id="name" 
          ...
          <p className="text-center text-sm text-muted-foreground">
            Already have an account? <Link href="/auth/login" className="font-bold text-foreground hover:underline">Sign in</Link>
          </p>
        </motion.div>
      </div>
